...
from backend.api import books, staff, authors, categories, publishers, reports
...
class BooksClient:
    def __init__(self):
        ...
        self.fields = ["book_id", "title", "description", "author", "publisher_name", "stock", "price", "genre", "isbn", "author_id", "publisher_id", "category_id"]
...
class UsersClient:
    ...
    def change_password(self, user_id, old, new):
        return handle_response(self.api.change_password, user_id, str(old), str(new))
...
class ReportsClient:
    ...
    def get_overview_summary(self, date=None):
        return handle_response(self.api.get_overview, fields=None)
