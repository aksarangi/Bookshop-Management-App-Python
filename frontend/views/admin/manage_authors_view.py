...
class AuthorFormDialog(simpledialog.Dialog):
    ...
    def body(self, master):
        ...
        ttk.Label(master, text="Bio:").grid(row=3, column=0, sticky="ne", padx=6, pady=6)
        self.bio_text = tk.Text(master, width=40, height=6)
        self.bio_text.grid(row=3, column=1, padx=6, pady=6)
...
class ManageAuthorsView(tk.Frame):
    ...
    def build_ui(self):
        ...
        # Treeview
        cols = ("author_id", "full_name", "country", "birth_year")
